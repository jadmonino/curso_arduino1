...
char*  mqtt_topic_pub = "curso_arduino/joseantonio";
char*  mqtt_client_id = "ESP_Jose_Antonio";
...
void loop() {
  ...
  if(now - lastMsg > 10000){
    lastMsg = now;
    String mensaje = "Hola, soy José Antonio";
...
// Funciones
// Mensaje recibido en [curso_arduino1/jose antonio]: Hola Mundo
